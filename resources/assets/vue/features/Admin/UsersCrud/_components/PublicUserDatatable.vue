<script lang="ts">
    ...
    export default class PublicUserDatatable extends Mixins(DatatableMixin) {

        endpoint: string = 'user/public';
  ...
  <!--<div class="row">
    <div class="col-xl-11">
      <div class="datatable users_datatable">
        <datatable-header v-model="tableData" :columns="columns" :addRouteName="'add.user'" :langKey="'users'" :endpoint="endpoint+'/export'" :export_file="'public_users'" :success="success" @getData="getData"></datatable-header>
