<script lang="ts">
    ...
    import UserBar from '@/components/AdminSection/UserBar.vue'
    ...
    export default class AdminHeader extends Vue {
        @State('adminHeaderTitle') adminHeaderTitle;
...
<template>
  ...
  <!-- end:: Header -->
    ...
    <!-- <header class="main-header container-fluid">
        <div class="row" v-click-outside="closeSubMenu">
            &lt;!&ndash;<div class="brand-name">{{ $t('general.site.name' )}}</div>&ndash;&gt;
          <div class="brand-name">
            ...
            <div class="header-wrap">
                ...
                <div class="user-menu">
                    ...
                    <ul v-if="menuOpened" id="user-menu-list" class="profile-list">
                        <li class="profile-menu-item my-profile"><router-link :to="{ name: `edit.user`, params: {userId: $auth.user().id} }"><i class="fa fa-user-o" aria-hidden="true"></i>{{$t('general.my.profile')}}</router-link></li>
                        <li class="profile-menu-item logout" @click.prevent="logout"><i class="fa fa-sign-out" aria-hidden="true"></i> {{$t('general.logout')}}</li>
                    </ul>
                </div>
            </div>
        </div>
