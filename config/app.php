...
return [
    ...
    */
    ...
    'display_errors_in_response' => env('APP_ERRORS_IN_RESPONSE', true),
    ...
    */
    ...
    'url' => env('APP_URL', 'http://starter.test'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Country for the application instance
    */

    'country' => env('APP_COUNTRY', 'BG'),
